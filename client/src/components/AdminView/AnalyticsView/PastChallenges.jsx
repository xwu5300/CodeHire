...
class PastChallenges extends Component {
  ...
  render() {
    return(
      ...
      </div> : <PastResults remove={this.props.remove} favorites={this.props.favorites.map((item) => item.user_id)} pastResults={this.props.pastResults} save={this.props.save} showTable={this.showTable}/>}
    </div>
    )
  }
}
