...
class CompanyNavBar extends Component {
  ...
  return (
      <div className="ui orange six item menu">
          ...
          <div className={this.props.history.location.pathname === '/admin/data' ? 'ui active item cursor' : 'ui item cursor' } onClick={() => {this.props.history.push('/admin/data')}}>Analytics</div>
          <div className={this.props.history.location.pathname === '/admin/hire' ? 'ui active item cursor' : 'ui item cursor' } onClick={() => {this.props.history.push('/admin/hire')}}>Hire</div>
          <div className='ui item cursor' onClick={() => this.props.handleLogout() }>Log Out</div>
      </div>
  )
 }
}
