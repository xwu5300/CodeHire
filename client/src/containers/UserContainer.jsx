...
const UserProfileViewComponent = connect(mapStateToProps, { fetchCandidateInfo, updateCandidateSkills, updateCandidateGithub, deleteCandidateSkill })(UserProfileView);
